    ...
    "Sri Lanka": {
        ...
        "states": {
            "Sri Lanka": {
                ...
                "amenities_file":    "sri_lanka_sri_lanka.geojson",  # v9.0 — raw OSM-extract GeoJSON (amenity/shop/leisure tags), not a CSV/XLSX like the India files
                "competitor_file":   None,
...
AMENITY_BUCKETS = {
    ...
    "cafe":              "food",
    "fast_food":         "food",
    "coffee":            "food",    # v9.0 — Sri Lanka OSM extract long tail
    "bakery":            "food",
    "pastry":            "food",
    "canteen":           "food",
    "supermarket":       "retail",
